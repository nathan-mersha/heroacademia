 ...
 * @name                heroAcademia
 * @module              teacher.js
 * @description         DAL for teacher route.
 * @kind                DAL
 * @copyright           Copyright : 2018
 */

let Model = require('../model/teacher');
...
/**
 * @name                - Get public
 * @description         - Retrieves teacher data that is public (some attributes may be hidden)
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Get private
 * @description         - Retrieves private teacher data
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
 ...
 * @description         - Retrieves teacher paginated data (public data - Attributes may be hidden)
 * @param query         - Query
...
/**
 * @name                - Update
 * @description         - Finds one teacher that matches query and updates
 * @param query         - Query
...
/**
 * @name                - Update many
 * @description         - Finds all teacher data that matches query and update
 * @param query         - Query
 * @param updateData    - Update data
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Remove
 * @description         - Finds teacher and removes.
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Remove many
 * @description         - Removes all teacher document that matches query
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
