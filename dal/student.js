 ...
 * @name                heroAcademia
 * @module              student.js
 * @description         DAL for student route.
 * @kind                DAL
...
/**
 * @name                - Get public
 * @description         - Retrieves student data that is public (some attributes may be hidden)
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Get private
 * @description         - Retrieves private student data
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
 ...
 * @description         - Retrieves student paginated data (public data - Attributes may be hidden)
 * @param query         - Query
...
/**
 * @name                - Update
 * @description         - Finds one student that matches query and updates
 * @param query         - Query
...
/**
 * @name                - Update many
 * @description         - Finds all student data that matches query and update
 * @param query         - Query
 * @param updateData    - Update data
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Remove
 * @description         - Finds student and removes.
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Remove many
 * @description         - Removes all student document that matches query
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
