 ...
 * @description         DAL for tournament route.
 * @kind                DAL
...
/**
 * @name                - Create
 * @description         - Creates new tournament
...
/**
 * @name                - Get public
 * @description         - Retrieves tournament data that is public (some attributes may be hidden)
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Get private
 * @description         - Retrieves private tournament data
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
 ...
 * @description         - Retrieves tournament paginated data (public data - Attributes may be hidden)
 * @param query         - Query
...
/**
 * @name                - Update
 * @description         - Finds one tournament that matches query and updates
 * @param query         - Query
...
/**
 * @name                - Update many
 * @description         - Finds all tournament data that matches query and update
 * @param query         - Query
 * @param updateData    - Update data
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Remove
 * @description         - Finds tournament and removes.
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Remove many
 * @description         - Removes all tournament document that matches query
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
